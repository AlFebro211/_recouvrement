...
urlpatterns =[
   ...
   path('get_existing_derogation_reduction/', views.get_existing_derogation_reduction, name='get_existing_derogation_reduction'),
   path('ajouter_paiement/', views.add_paiement_for_anyclass, name='ajouter_paiement'),
   path('get_pupils_with_unpaid/', views.get_pupils_with_unpaid, name='get_pupils_with_unpaid'),
   ...
   path('get_classes_with_penalite/', views.get_classes_with_penalite, name='get_classes_with_penalite'),
   path('get_trimestres_with_penalite/', views.get_trimestres_with_penalite, name='get_trimestres_with_penalite'),
   path('get_variables_with_penalite/', views.get_variables_with_penalite, name='get_variables_with_penalite'),
